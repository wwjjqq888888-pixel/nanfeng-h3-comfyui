...
class H3FaceTrackCrop:
    ...
    def run(self, images, detector, confidence, crop_factor, canvas_width, canvas_height,
        ...
        strict_identity = identity_reference is not None and ref_emb is not None
        ...
        for i in range(B):
            ...
            b = None
            if strict_identity:
                # An explicitly selected identity must never fall through to another visible
                # person. If the target is absent/occluded or similarity is too low, leave this
                # frame unresolved so interpolation/fade handles it instead of switching faces.
...
NODE_CLASS_MAPPINGS = {
    "H3SelectIdentityFace": H3SelectIdentityFace,
...
NODE_DISPLAY_NAME_MAPPINGS = {
    "H3SelectIdentityFace": "H3 Select Identity Face",
